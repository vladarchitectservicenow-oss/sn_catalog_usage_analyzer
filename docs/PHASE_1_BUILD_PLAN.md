...
**Repository:** sn_catalog_usage_analyzer
...
Build a production-ready ServiceNow scoped application that deep analytics on servicenow service catalog item usage patterns, abandonment rates, and request throughput to identify underutilized items and catalog optimization opportunities.. The application must be installable on any Australia-era ServiceNow instance and must pass automated functional tests with zero external runtime dependencies.
